...
import { Wallet, TrendingUp, TrendingDown, CreditCard, Bitcoin, Building2, AlertTriangle, Target, ArrowUpRight, ArrowDownRight } from 'lucide-react';
...
export default function Dashboard() {
    const { totalBankBalance, monthlyFixedIncome, monthlyFixedExpenses, currentMonthInstallments, cryptos, accounts, incomes, cards, get12MonthProjection, getExpensesByCategory } = useFinance();
